...
module.exports = {
  up: async (queryInterface, Sequelize) => {
      ...
      await queryInterface.bulkInsert('anythingGoes', [{
        ...
        quote: 'Being ambivalent does not mean that you are a relevatist, that anything goes; it just means that you show the complexity of life. Life is always complex. --Etgar Keret',
        createdAt: new date(),
        updatedAt: new Date()
      
      },{
        quote: 'In a fight almost anything goes. It almost reaches the point where you stop to apologize if a chance blow lands above the belt. --Wayne Gretzky',
        createdAt: new date(),
        updatedAt: new Date()
        ...
        quote: 'A champion is someone who gets up when they can’t. -- Jack Dempsey',
        createdAt: new date(),
        updatedAt: new Date()
      
      },{
        quote: 'Anything goes. You always find interesting things that way. -- Beck',
        createdAt: new date(),
        updatedAt: new Date()
