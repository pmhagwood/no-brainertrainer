...
module.exports = {
  up: async (queryInterface, Sequelize) => {
      ...
      await queryInterface.bulkInsert('relax', [{
        ...
        quote: 'Trust yourself. You have survived a lot, and you will survive whatever is coming. -- Robert Tew',
        createdAt: new date(),
        updatedAt: new Date()
      
      },{
        uoqte: 'Act the way that you want to feel. -- Gretchen Rubin',
        createdAt: new date(),
        updatedAt: new Date()
        ...
        quote: 'Your mind will answer most questions if you learn to relax and wait for the answer. -- William Burroughs',
        createdAt: new date(),
        updatedAt: new Date()
        ...
        quote: 'Keep walking through the storm. Your rainbow is waiting on the other side. -- Heather Stillufsen',
        createdAt: new date(),
        updatedAt: new Date()
        ...
        quote: 'It is not stress that kills us, it is our reaction to it. -- Hans Selye',
        createdAt: new date(),
        updatedAt: new Date()
