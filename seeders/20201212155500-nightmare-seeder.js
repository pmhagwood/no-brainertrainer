...
module.exports = {
  up: async (queryInterface, Sequelize) => {
      ...
      await queryInterface.bulkInsert('nightmare', [{
        quote: 'The more you sweat in training, the less you bleed in combat. --Navy SEAL’s',
        createdAt: new date(),
        updatedAt: new Date()
      
      },{
        quote: 'The pain of discipline is nothing like the pain of disappointment --Justin Langer',
        createdAt: new date(),
        updatedAt: new Date()
